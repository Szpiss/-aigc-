...
var LearningRecordModel = /** @class */ (function (_super) {
    __extends(LearningRecordModel, _super);
    function LearningRecordModel() {
    ...
    LearningRecordModel.$collection = 'learningRecord';
    return LearningRecordModel;
}(base_1.default));
exports.default = LearningRecordModel;
